...
bool BtOgreFramework::initOgre(Ogre::String wndTitle, OIS::KeyListener *pKeyListener, OIS::MouseListener *pMouseListener)
{
    ...
    //setup root scene node
    m_pRoot = new Ogre::Root();
    
    if(!m_pRoot->showConfigDialog())
        return false;
    
    //setup viewport and render window
...
//all updates handled by the application state
//only put central ogre application wide update tasks here
