...
{
    BtOgreFramework::getSingletonPtr()->m_pKeyboard->setEventCallback(state);
	BtOgreFramework::getSingletonPtr()->m_pMouse->setEventCallback(state);
    BtOgreFramework::getSingletonPtr()->m_pTrayMgr->setListener(state);
